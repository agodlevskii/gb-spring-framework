...
GRANT ALL PRIVILEGES ON TABLE products TO geek;
GRANT ALL PRIVILEGES ON TABLE products_id_seq TO geek;

INSERT INTO products (name, cost) VALUES ('Product 1', 199.99), ('Product 2', 299.99), ('Product 3', 399.99), ('Product 4', 499.99),
